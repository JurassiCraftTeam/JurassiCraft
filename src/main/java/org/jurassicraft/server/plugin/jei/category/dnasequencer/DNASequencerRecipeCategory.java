...
public class DNASequencerRecipeCategory implements IRecipeCategory<DNASequencerRecipeWrapper> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(JurassiCraft.MODID, "textures/gui/dna_sequencer.png");
    ...
    public String getUid() {
        return JurassiCraftJEIPlugin.DNA_SEQUENCER;
    }
