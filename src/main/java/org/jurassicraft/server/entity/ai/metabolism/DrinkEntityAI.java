...
import org.jurassicraft.server.entity.ai.BlockRingBuffer;
...
public class DrinkEntityAI extends EntityAIBase {
    ...
    protected volatile BlockRingBuffer unreachable = new BlockRingBuffer(10);//List<BlockPos> unreachable = new ArrayList<BlockPos>();
							...
							tpe.execute(new ThreadRunnable(this, this.dinosaur) {
								...
								public void run() {
									synchronized (world) {
										...
										BlockPos pos = distanceMap.get(sortedList.get(0));
